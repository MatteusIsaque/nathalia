...
export default function DadTable() {
  return (
    <article id="dadTable" className={styles.Articles}>
      {/* <SonTable ColorStrong={'var(--purple)'} colorMonth={'var(--purple)'} TitleTable="PACOTE 1M" 
      Price={150} 
      PriceMonth={150}
       MonthTraining="1 MÊS DE TREINO" Vantagem1="ACOMPANHAMENTO" Vantagem2="TREINO PERSONALIZADO" Vantagem3="FEEDBACK SEMANAL" Vantagem4="SUPORTE 7/7" Vantagem5="APP EXCLUSIVO" /> */}
